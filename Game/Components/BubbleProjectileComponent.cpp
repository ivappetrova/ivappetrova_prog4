...
namespace dae
{
	BubbleProjectileComponent::BubbleProjectileComponent(GameObject* owner, Scene& scene, float directionX, float windowHeight, LevelCollisionComponent* pLevelCol)
